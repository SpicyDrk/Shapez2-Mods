...
namespace MoreLayers.Tests;

/// <summary>
/// Smoke check for the MoreLayers mod's <c>manifest.json</c>. Returns exit code
/// 0 if all assertions pass, 1 otherwise. Mirrors HelloWorld.Tests verbatim
/// modulo the mod name — see HelloWorld.Tests.Program for the full rationale
/// on why this is a console app and not xunit.
/// </summary>
public static class Program
{
    private const string ModName = "MoreLayers";
