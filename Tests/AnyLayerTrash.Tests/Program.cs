...
namespace AnyLayerTrash.Tests;

/// <summary>
/// Smoke check for the AnyLayerTrash mod's <c>manifest.json</c>. Mirrors
/// Tests/SmartCutter.Tests/Program.cs — same five manifest assertions, different
/// <c>ModName</c>. Exits 0 on all-pass, 1 otherwise.
/// </summary>
public static class Program
{
    private const string ModName = "AnyLayerTrash";
